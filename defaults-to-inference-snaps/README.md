...
Content sharing from the inference manager snap (`inference`) to inference snaps (e.g. `gemma3-jane`).
...
```bash
inference install gemma3-jane --engine intel-gpu --model gemma3-270m
```
